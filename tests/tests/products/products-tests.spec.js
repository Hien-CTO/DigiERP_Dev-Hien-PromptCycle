...
test.describe('Products Page Tests', () => {
  ...
  test.describe('Products Page Access and Authentication', () => {
    ...
    test('should redirect to login when not authenticated', async ({ page }) => {
      // Clear storage to ensure not authenticated
      await browserHelper.clearAllStorage();
  ...
  //   // test('should load products page after successful login', async ({ page }) => {
  ...
  //   //   // Đợi redirect và verify authentication
  //   //   await page.waitForURL('**/admin**', { timeout: 10000 });
      
  //   //   // Đợi thêm một chút để đảm bảo auth state được initialize
  //   //   await page.waitForTimeout(2000);
      
  //   //   // Verify we're on admin page
  //   //   const urlAfterLogin = page.url();
  //   //   expect(urlAfterLogin).toContain('/admin');
      
  //   //   // Navigate to products page (goto() already waits for URL internally)
  //   //   await productsPage.goto();
      
  //   //   // Debug: Check actual URL
  //   //   const actualUrl = page.url();
  //   //   console.log('Actual URL after goto:', actualUrl);
      
  //   //   // Verify we're on products page (not redirected to login)
  //   //   expect(actualUrl).toContain('/admin/products');
      
  //   //   // Verify products page loaded (isProductsPageLoaded() now checks multiple indicators)
  ...
  //   //   expect(pageTitle).toContain('Quản lý');
  //   // });
  // });
